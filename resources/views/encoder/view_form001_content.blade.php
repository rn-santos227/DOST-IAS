              ...
              @foreach($a_findings as $a_finding)
                ...
                <tr id="fcontent_row" class="treffect_{{$a_finding->auditfinding_no}} " style="color: {{ $a_finding->archive_status == 0 ? "" : "red" }}">
                  ...
                  <td width="10%" id="status_{{$a_finding->id}}" style="text-align: center">
                      ...
                      @else
                        <h5 class="text-info"> for review and approval</h5>
                      @endif  
                  ...
                  <td width="11%"> 
                   <center> 
                        ...
                        @if($a_finding->archive_status == 0)
                          <button data-toggle="modal" data-target="#myModal" title="Update Content" class="btn btn-trans update_c " value="" id="update_c_{{ $a_finding->auditfinding_no }}" {{ check_status_if_fma($a_finding->form_001_id) }}>
