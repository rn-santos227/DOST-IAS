<div class="x_panel tile  ">
  ...
  <center>
    ...
    <div style="height: 45px; display: none" class="alert alert-danger error_email_create" role="alert">
       <h4><i class="fa fa-times-circle-o" aria-hidden="true"></i> Error! Please enter a valid Email Address! (*)</h4>
    </div>
    <div style="height: 45px; display: none" class="alert alert-success success_create" role="alert">
       <h4><i class="fa fa-check-circle" aria-hidden="true"></i> Success! Encoder's data has been created!</h4>
    </div>
  </center><br>
    <form id="storeEncoderForm" data-parsley-validate class="form-horizontal form-label-left">
    {{ csrf_field() }}
      ...
      <div class="form-group pull">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pull-right">
          ...
          <button class="create_user btn btn-success" id="submit_user" >Submit</button>
        </div>
      </div>
    </form>
  </div>
