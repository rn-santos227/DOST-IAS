<div class="x_panel tile  ">
  ...
  <center>
    ...
    <form id="updateAuditorsForm" data-parsley-validate class="form-horizontal form-label-left">
    {{ csrf_field() }}
    <input type="hidden" name="_id" value="0">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
          <input style="width: 305px; border-radius: 0px;" type="text" id="u_agency" name="u_agency" required="required" class="form-control col-md-7 col-xs-12">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group" style="display: none">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
          <input id="middle-name" class="form-control col-md-7 col-xs-12" required="required" type="text" name="role" value="4" placeholder="IAS Staff" readonly="">
        </div>
      </div>
      ...
      <div class="form-group pull">
        <div class="col-md-7 col-sm-7 col-xs-12 col-md-offset-3 pull-right">
          ...
          <button class="btn btn-success update_auditorss" id="submit_auditors" >Update</button>
        </div>
      </div>
    </form>
  </div>
