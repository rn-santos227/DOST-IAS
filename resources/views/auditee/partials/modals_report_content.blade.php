...
<div class="modal fade" id="viewContentModal" role="dialog" aria-labelledby="viewContentModalLabel">
        <div class="modal-dialog modal-lg" style="width: 1600px" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="panel-body">
                <form id="FormSubmitMgtAction" class="form-horizontal" method="POST">
                      {{ csrf_field() }}        
                  ...
                  <table style="border: 1px solid; background: #36404f; color:white; min-width: 1535px; text-align: center;">
                    <tbody>
                      <tr>
                        <th style="border: 1px solid black; width: 7%;">
                          <div class="form-group">
                            <label for="audit_mem" class="col-md-8 control-label">No.</label>
                            <div style="margin-left: 7px; margin-top: 15px;" id="auditarea" class="col-md-12"></div>
                          </div>
                        </th>
                        <th style="border: 1px solid black; width: 31%">
                          <div class="form-group">
                            <label for="audit_mem" class="col-md-7 control-label">FINDINGS</label>
                            <div id="subauditarea" class="col-md-12" style="margin-top: 15px; margin-left: 15px;"></div>
                          </div>
                        </th>
                        <th style="border: 1px solid black; width: 25%">
                          <div class="form-group">
                            <label for="audit_mem" class="col-md-8 control-label">RECOMMENDATIONS</label>
                            <div id="customarea" class="col-md-12" style="margin-top: 15px; margin-left: 20px;"></div>
                          </div>
                        </th>
                        <th style="border: 1px solid black; width: 33%">
                          <div class="form-group">
                            <label for="audit_mem" class="col-md-8 control-label">MANAGEMENT ACTIONS</label>
                            <div id="customarea" class="col-md-12" style="margin-top: 15px; margin-left: 20px;"></div>
                          </div>
                        </th>
                      </tr>
                  ...
                  <div class="row">
                    <div class="col-xs-3 col-md-1">
                      <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <div style="text-align: center; margin-top: 15px; color: black" id="af_no" class="col-md-12"></div>
                      </div>
                    </div>

                    <div style="width: 30%" class="col-xs-6 col-md-4">
                      <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <div id="af_findings" class="col-md-12" style="margin-top: 15px; color: black"></div>
                      </div>
                    </div>

                    <div style="width:60%" class="col-xs-5 col-md-4">
                      <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <tr>
                        <textarea id="mgtactions" name="mgtactions" style="display: none;"></textarea>
                         <div id="recommendation_div" style="min-height: 200px; margin-top: 40px; background-color: ; color: black">
                          <ol class="rmd" style="list-style: none"></ol>
                        </div>
                      </div>
                    </div>
                  </div>
