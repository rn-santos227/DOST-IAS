<div class="x_panel tile  ">
  ...
  <center>
    ...
    <div style="height: 45px; display: none" class="alert alert-success success_create" role="alert">
       <h4><i class="fa fa-check-circle" aria-hidden="true"></i> Success! Auditor's data has been created!</h4>
    </div>
  </center><br>
    <form id="storeAuditorsForm" data-parsley-validate class="form-horizontal form-label-left">
    {{ csrf_field() }}
      ...
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12" for="agency" >Agency <span class="required">*</span></label>
        <div class="col-md-8 col-sm-6 col-xs-12">
          <input id="agency" class="form-control col-md-7 col-xs-12" required="required" type="text" name="agency">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group" style="display: none">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
          <input id="middle-name" class="form-control col-md-7 col-xs-12" required="required" type="text" name="role" value="4" placeholder="Auditor" readonly="">
        </div>
      </div>
      ...
      <div class="form-group pull">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pull-right">
          ...
          <button class="create_user btn btn-success" id="submit_auditors" >Submit</button>
        </div>
      </div>
    </form>
  </div>
